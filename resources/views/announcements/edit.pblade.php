                ...
                <form method="POST" action="{{ route('announcements.update', $announcement->id) }}" class="p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="title" name="title" class="block mt-1 w-full" value="{{ old('title', $announcement->title) }}" required>
                        </div>

                        <!-- Content -->
                        <div>
                            <label for="content" class="block font-medium text-sm text-gray-700">Content</label>
                            <textarea id="content" name="content" rows="6" class="block mt-1 w-full" required>{{ old('content', $announcement->content) }}</textarea>
                        </div>
                    </div>
